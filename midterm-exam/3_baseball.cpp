	...
	while (1) {
		...
		while (1) {
			...
			if (to_string(userNumber).length() != 3) {
				...
				guessSecond = (userNumber-guessFirst)/10;
		...
		if(First == guessFirst || First == guessSecond || First == guessThird){
			if(First == guessFirst)
				strike++;
			else
				ball++;
		}
		if(Second == guessFirst || Second == guessSecond || Second == guessThird){
			if(Second == guessSecond)
				strike++;
			else
				ball++;
		}
		if(Third == guessFirst || Third == guessSecond || Third == guessThird){
			if(Third == guessThird)
				strike++;
			else
				ball++;
